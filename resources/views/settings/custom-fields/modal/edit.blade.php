        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="main_menu_id" name="main_menu_id"
                        value="{{ $result->main_menu->menu_name }}" readonly>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="sub_menu_id" id="sub_menu_id"
                        value="{{ $result->sub_menu->menu_name }}" readonly>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="label" name="label"
                        placeholder="@lang('translation.FieldLabel')" autocomplete="off" value="{{ $result->label }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="field_placeholder" name="field_placeholder"
                        placeholder="@lang('translation.Placeholder')" autocomplete="off" value="{{ $result->field_placeholder }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <select class="form-control" id="field_type" name="field_type" disabled>
                        ...
                        @foreach ($field_types as $key => $field_type)
                            <option value="{{ $key }}" {{ $key == $result->field_type ? 'selected' : '' }}>
                                {{ $field_type }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-3 field_length" @if (!in_array($result->field_type, ['text', 'textarea'])) style="display: none;" @endif>
                <div class="form-group mb-3">
            ...
            <div class="col-md-3 field_length" @if (!in_array($result->field_type, ['text', 'textarea'])) style="display: none;" @endif>
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="maximum_length" name="maximum_length"
                        ...
                        oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"
                        value="{{ $result->maximum_length }}">
                </div>
            </div>
        </div>
        <div class="row" id="field_values" @if (!in_array($result->field_type, ['select', 'radio', 'checkbox'])) style="display: none" @endif>
                    ...
                    <table class="table table-bordered text-nwrap mb-0" id="itemsTable">
                        ...
                        <tbody class="text-dark">
                            ...
                            @if ($result->field_options != '')
                                @php
                                    $field_values = explode(',', $result->field_options);
                                @endphp
                                @foreach ($field_values as $field_value)
                                    <tr class="item-row">
                                        <td></td>
                                        <td><input required type="text" class="form-control"
                                                name="field_options[]" value="{{ $field_value }}"
                                                placeholder="Value">
                                        </td>
                                        <td><a href="javascript:void(0);"
                                                class="btn btn-danger btn-sm remove-item">Remove</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="is_required" name="is_required"
                            value="1" @if ($result->is_required) checked @endif>
