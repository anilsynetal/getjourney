...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> @lang('translation.SubMenues') /</span>
            @lang('translation.AddSubmenu')</h5>
        <div class="card">
            <div class="card-header d-flex justify-content-between pb-0">
                <h5 class="card-title">
                    @lang('translation.AddSubmenu')
                </h5>
            </div>
            <div class="card-body">
                <form name="master_form" method="post" action="{{ $route_action }}" novalidate>
                    ...
                    <div class="row icon-demo-content d-none">
                        @foreach ($icons as $icon)
                            <div class="col-xl-3 col-lg-4 col-sm-6 icon-demo">
                                <i class="{{ $icon }}"></i> {{ $icon }}
                            </div>
                        @endforeach
                    </div>
