...
@section('css')
    ...
    <style>
        ...
        .icon-demo-content li {
            width: 22%;
            /* Makes 4 items per row */
            padding: 10px;
            margin: 5px;
            text-align: center;
            cursor: pointer;
        ...
        .icon-demo-content li i {
            font-size: 24px;
            color: #333;
            margin-right: auto;
        }

        .icon-demo-content li:hover,
        .icon-demo-content li.active {
            background: #007bff;
            color: #fff;
        }

        .icon-demo-content li.active i {
            color: #fff;
        }
    </style>
@endsection
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> @lang('translation.MainMenus') /</span>
            @lang('translation.EditMainMenu')</h5>
        <div class="card">
            <div class="card-header d-flex justify-content-between pb-0">
                <h5 class="card-title">
                    @lang('translation.EditMainMenu')
                </h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="hidden" class="form-control" id="menu_icon" name="menu_icon"
                                    placeholder="@lang('translation.SelectIcon')" autocomplete="off" required
                                    value="{{ $result->menu_icon }}">
                                <input type="text" class="form-control mb-2" id="icon-search"
                                    placeholder="@lang('translation.SearchIcons')..." value="{{ $result->menu_icon }}">
                            </div>
                            <div class="icon-container">
                                <ul class="icon-demo-content">
                                    @foreach ($icons as $icon)
                                        <li class="icon-demo {{ $icon == $result->menu_icon ? 'active' : '' }}"
