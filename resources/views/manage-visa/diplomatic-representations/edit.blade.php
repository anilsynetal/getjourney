...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-4">
            ...
            @lang('translation.Edit') @lang('translation.DiplomaticRepresentation')
        </h5>
        <div class="card">
            <div class="card-body">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="contact_number1" name="contact_number1"
                                    value="{{ $result->contact_number1 }}" placeholder="@lang('translation.EnterPhone')">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="contact_number2" name="contact_number2"
                                    value="{{ $result->contact_number2 }}" placeholder="@lang('translation.EnterPhone')">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="fax_number" name="fax_number"
                                    value="{{ $result->fax_number }}" placeholder="@lang('translation.FaxNumber')">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group mb-3">
