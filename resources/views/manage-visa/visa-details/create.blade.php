...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-4">
            ...
            @lang('translation.Add') @lang('translation.VisaDetail')
        </h5>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="city" name="city"
                                            list="city-list" placeholder="@lang('translation.EnterCity')" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea id="visa_fees" name="visa_fees" class="form-control" placeholder="@lang('translation.EnterVisaFees')" rows="4"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group mb-3">
