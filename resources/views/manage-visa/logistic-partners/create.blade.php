...
@section('title')
    {{ __('translation.Add') . ' ' . __('translation.LogisticPartner') }}
@endsection
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-4">
            ...
            @lang('translation.Add') @lang('translation.LogisticPartner')
        </h5>
        <div class="card">
            <div class="card-body">
                <form name="master_form" method="post" action="{{ route('manage-visa.logistic-partners.store') }}" novalidate>
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="contact_number" name="contact_number"
                                    placeholder="@lang('translation.EnterContactNumber')" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group mb-3">
