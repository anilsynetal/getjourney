        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group  mb-3">
                    <label for="current_password" class="form-label">@lang('translation.CurrentPassword')<span
                            class="text-danger">*</span>:</label>
                    <div class="input-group auth-pass-inputgroup">
                        <input type="password" placeholder="@lang('translation.CurrentPassword')" name="current_password"
                            class="form-control" id="current_password" autocomplete="off">
                        <button class="btn btn-light ms-0" type="button" id="current-password-eye-button"
                            onclick="toggleEyeButton('current-password-eye-button','current_password');"><i
            ...
            <div class="col-md-12 col-sm-12">
                <div class="modal-footer">
                    <button type="button" class="btn btn-dark close" data-bs-dismiss="modal">Close</button>
