...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> @lang('translation.Roles') /</span>
            @lang('translation.AddRole')</h5>
        <div class="card">
            <div class="card-header d-flex justify-content-between pb-0">
                <h5 class="card-title">
                    @lang('translation.AddRole')
                </h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="@lang('translation.RoleName')" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="form-group custom-form-select">
                                                        ...
                                                        @foreach ($permissions as $permission)
                                                            <div class="custom-form-inner-select">
                                                                <input type="checkbox" data-module="{{ $menu_name }}"
