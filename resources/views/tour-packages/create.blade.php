        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="master_form" method="post" action="{{ route('tour-packages.store') }}"
                                                ...
                                                @else
                                                    ...
                                                    @elseif($field['type'] == 'file')
                                                        <input type="file" class="form-control {{ $field['class'] }}"
                                                            ...
                                                            {{ $field['required'] ? 'required' : '' }}>
                                                        @if (isset($field['old_image']) && $field['old_image'])
                                                            <div class="mt-2">
                                                                <img src="{{ asset($field['old_image']) }}"
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bx bx-save me-1"></i> {{ __('translation.Save') }}
                                        </button>
                                    </div>
                                </div>
                            </div>
