...
class CaseStudy extends Model
{
    ...
    static function getTableData()
    {
        ...
        return array(
            'title' => __('translation.CaseStudies'),
            'module' => __('translation.Dashboard'),
            'active_page' => __('translation.CaseStudyList'),
            'is_add' => auth()->user()->can('case-studies.add') ? true : false,
            'is_modal' => true,
            'is_modal_large' => false,
            'is_back_button' => false,
            'view_deleted_btn' => auth()->user()->can('case-studies.restore') ? false : false,
            'back_route' => route('case-studies.index'),
            'index_route' => route('case-studies.index'),
            'create_route' => route('case-studies.create'),
            'columns' => [
                '#',
            ...
            'ajax_url' => route('case-studies.get-ajax-data'),
            'buttons' => $buttons,
            'js_columns' => [
